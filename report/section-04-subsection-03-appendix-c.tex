...
\noindent
\begin{minipage}{.6in}
  \qrcode[height=.5in]{https://raw.githubusercontent.com/mviitanen/ati-java-apprentice/master/code/1-3-list-of-strings/src/org/familysearch/viitanenm/HeapSizeExample.java}
\end{minipage}
\begin{minipage}{6in}
