\subsection*{Appendix F -- Sorting In the File System} \label{App:AppendixG}
\addcontentsline{toc}{subsection}{Appendix G} % Adds this section to the table of contents
